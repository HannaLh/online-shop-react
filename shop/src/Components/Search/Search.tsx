    ...
    return (
        <div className="search">
            <input
                ...
                name="q"
                placeholder="Search" />
            <label htmlFor="search__input-id" className="search__label">
                {value && (
                    <svg onClick={onClickClear} className="search__clear-icon" data-name="Livello 1" id="Livello_1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"><title />
